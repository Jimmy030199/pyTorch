...
class IrisMLP(nn.Module):
    def __init__(self, in_dim=4, hidden1=32,hidden2=16,out_dim=3,dropout=0.5):
        super().__init__()
...
# 儲存圖表
curve_path = os.path.join(PLOTS, "curves3.png")
...
cm_path = os.path.join(PLOTS, "confusion_matrix3.png")
